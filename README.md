...
## User Stories
- As a visitor, I want to view stock information by entering a ticker symbol, so that I can quickly access market data without needing to create an account.
- As a visitor, I want to sign up for an account.
- As a registered user, I want to log in to my account, so that I can save my favorite stocks in a personalized watchlist.
- As a registered user, I want to log in to my account, so that I can access my watchlist and view my favourite stocks’ information.
- As a registered user, I want to log in to my account, so that I can access add any stock in my simulated holding.
- As a registered user, I want to log in to my account, so that I can access my simulated holding and view day’s gain and total gain.
- As a registered user, I want to log out of my account, so that my information remains secure when I’m not using the application.
